...
-   clone the repository by running `git clone https://github.com/Grainular-Nord/nord.dev.git` in your terminal or shell to clone the repo into the current directory.
